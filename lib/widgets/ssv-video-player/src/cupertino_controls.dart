...
import 'package:newarea/widgets/ssv-video-player/src/cupertino_progress_bar.dart';
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Container(
              height: barHeight,
              color: backgroundColor,
              child: ssvVideoPlayerController.isLive
                  ? Row(
    ...
    return Expanded(
      child: Padding(
        ...
        child: CupertinoVideoProgressBar(
          ...
          colors: ssvVideoPlayerController.cupertinoProgressColors ??
